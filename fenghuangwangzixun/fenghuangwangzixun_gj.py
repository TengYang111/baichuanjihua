...
class InformationFhSpider(baseSpider):
    ...
    bash_url = 'http://news.ifeng.com/listpage/11574/'
    last_url = '/1/rtlist.shtml'
    ...
    def start_requests(self):
        ...
        if date > 5:#可以调节大小
            for j in range(date-5,date+1):
                website_url = self.bash_url + year + month + str(j) + self.last_url
                # print(website_url)
    ...
    def parse_content(self,response):
        ...
        news_author = response.xpath('//*[@id="artical_sth"]/p/span[3]/span/a/text()|//div[@class="yc_tit"]/p/a/text()|//span[@class="ss03"]/text()').extract_first()
