...
class InformationFhSpider(baseSpider):
    ...
    start_urls = ['http://tech.163.com/special/0009rt/ycbd.html']
    ...
    def start_requests(self):
        for i in range(1,11):
            if i == 1:
                ...
                website_url = 'http://tech.163.com/special/0009rt/ycbd_10.html'
            elif i== 9:
                website_url = 'http://tech.163.com/special/0009rt/ycbd_09.html'
            else:
                website_url = 'http://tech.163.com/special/0009rt/ycbd_0' + str(i) + '.html'
    ...
    def parse_news(self,response):#这个函数做的是获取新闻的url
        news_urls = response.xpath('//div[@class="leftList1"]/ul/li/span[@class="text"]/a/@href').extract()
    ...
    def parse_content(self,response):
        ...
        if image_urls1 != []:
            ...
            for i in range(len(image_urls)):
                if i <10 and i>=0:
                    image_name = news_title + '000' + str(i)
                    image_names.append(image_name)
                elif i <100 and i>=10:
                    image_name = news_title + '00' + str(i)
                    image_names.append(image_name)
                elif i <1000 and i>=100:
                    image_name = news_title + '0' + str(i)
                    image_names.append(image_name)
                else:
